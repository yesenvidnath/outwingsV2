// Adding Header to the website

class MainHeader extends HTMLElement {
  connectedCallback() {
    this.innerHTML = `
        <header>
        <a href="#" class="logo">Outwings <span>Coaching</span></a>
        ...
        <nav>
          ...
          <ul>
            ...
            <li><a href="#">Nila's Coaching Club</a></li>
            <li><a href="#">Reflections</a></li>
            <li><a href="#">Blog</a></li>
            <li><a href="#" class="nav-btn-pro"> Meet Your Coach</a></li>
          </ul>
        </nav>
...
// Adding Random Quate generator

class Quate extends HTMLElement {
  connectedCallback() {
    this.innerHTML = `
    ...
    <section class="quote">
        ...
        <div class="container">
            ...
            <div class="buttons"> 
                ...
                <button class="next" onclick="getNewQuote()">Read More Quotes</button>
            </div>
...
customElements.define('my-quote', Quate)
